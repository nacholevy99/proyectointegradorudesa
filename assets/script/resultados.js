    ...
    .then(function(datos){
       ...
       //Tracks, linea 29 boton para escuchar la musica//
        resultados.forEach(function(resultado){
            lista.innerHTML += `<li><a href="detail.html?track=${resultado.id}"><div class="grid-item">${resultado.title}</div></a> <a href="detail.html?artists=${resultado.id}" style="text-decoration: none">
            </li>`;
